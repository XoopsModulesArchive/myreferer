...
if (!Utility::existTable('myref_config')) {
    $ver = '1';
} else {
...
$myref_pages_stats         = $myref_pages_stats ?? 100;
$myref_query_stats         = $myref_query_stats ?? 100;
$myref_query_pages_stats   = $myref_query_pages_stats ?? 100;
$myref_referer_stats       = $myref_referer_stats ?? 100;
$myref_referer_pages_stats = $myref_referer_pages_stats ?? 100;
$myref_robots_stats        = $myref_robots_stats ?? 100;
$myref_robots_pages_stats  = $myref_robots_pages_stats ?? 100;
$myref_users_stats         = $myref_users_stats ?? 100;
$myref_users_pages_stats   = $myref_users_pages_stats ?? 100;
...
switch ($ver) {
    ...
    case '1.0':
        ...
        if (Utility::existTable('myref_config') && ret) {
        ...
        if (!Utility::getMeta('myref_pages_stats') && ret) {
        ...
        if (!Utility::getMeta('myref_query_stats') && ret) {
        ...
        if (!Utility::getMeta('myref_query_pages_stats') && ret) {
        ...
        if (!Utility::getMeta('myref_referer_stats') && ret) {
        ...
        if (!Utility::getMeta('myref_referer_pages_stats') && ret) {
        ...
        if (!Utility::getMeta('myref_robots_stats') && ret) {
        ...
        if (!Utility::getMeta('myref_robots_pages_stats') && ret) {
        ...
        if (!Utility::getMeta('myref_users_stats') && ret) {
        ...
        if (!Utility::getMeta('myref_users_pages_stats') && ret) {
        ...
        echo '</ul>';
        // ----------------------------------------------------------------------------------------------------------------- //
        if (!Utility::existTable('myref_pages') && ret) {
        ...
        // ----------------------------------------------------------------------------------------------------------------- //
        if (!Utility::existTable('myref_pages_stats') && ret) {
        ...
        // ----------------------------------------------------------------------------------------------------------------- //
        if (!Utility::existTable('myref_query_stats') && ret) {
        ...
        // ----------------------------------------------------------------------------------------------------------------- //
        if (!Utility::existTable('myref_query_pages') && ret) {
        ...
        // ----------------------------------------------------------------------------------------------------------------- //
        if (!Utility::existTable('myref_query_pages_stats') && ret) {
        ...
        // ----------------------------------------------------------------------------------------------------------------- //
        if (!Utility::existTable('myref_referer_stats') && ret) {
        ...
        // ----------------------------------------------------------------------------------------------------------------- //
        if (!Utility::existTable('myref_referer_pages') && ret) {
        ...
        // ----------------------------------------------------------------------------------------------------------------- //
        if (!Utility::existTable('myref_referer_pages_stats') && ret) {
        ...
        // ----------------------------------------------------------------------------------------------------------------- //
        if (!Utility::existTable('myref_robots_stats') && ret) {
        ...
        // ----------------------------------------------------------------------------------------------------------------- //
        if (!Utility::existTable('myref_robots_pages') && ret) {
        ...
        // ----------------------------------------------------------------------------------------------------------------- //
        if (!Utility::existTable('myref_robots_pages_stats') && ret) {
        ...
        // ----------------------------------------------------------------------------------------------------------------- //
        if (!Utility::existTable('myref_users') && ret) {
            ...
            $table = $xoopsDB->prefix() . '_myref_users';
            if (!Utility::existFieldname('myref_users', 'tracker') && ret) {
        ...
        // ----------------------------------------------------------------------------------------------------------------- //
        if (!Utility::existTable('myref_users_stats') && ret) {
        ...
        // ----------------------------------------------------------------------------------------------------------------- //
        if (!Utility::existTable('myref_users_pages') && ret) {
        ...
        // ----------------------------------------------------------------------------------------------------------------- //
        if (!Utility::existTable('myref_users_pages_stats') && ret) {
