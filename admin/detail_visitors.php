...
if (0 == $count) {
    ...
    if (1 == $myrow['tracker']) {
        $tracker = '&nbsp;<a href="detail_visitors.php?op=tracker_off&id=' . $myrow['id'] . '">
				<img src="../assets/images/icon/tracker_off.gif" alt="' . _MD_MYREFERER_USERVISIT_OFF . '" valign="absmiddle"></a>';
    } else {
        $tracker = '&nbsp;<a href="detail_visitors.php?op=tracker_on&id=' . $myrow['id'] . '">
				<img src="../assets/images/icon/tracker_on.gif" alt="' . _MD_MYREFERER_USERVISIT_ON . '" valign="absmiddle"></a>';
    }
