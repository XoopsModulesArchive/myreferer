...
if ( $op == 'blacklist' ) {
	...
	$black = '<a href="stats_modules_referer.php?ord='.$ord.'&search='.$search.'&week='.$week.'&op=='.$startart.'">
			<img src="../images/icon/all.gif" alt="'._MD_MYREFERER_ALL.'" align="absmiddle" /></a>';

	$black .= '<a href="stats_modules_referer.php?ord='.$ord.'&search='.$search.'&week='.$week.'&op=whitelist&startart='.$startart.'">
	...
	$black .= '<a href="stats_modules_referer.php?ord='.$ord.'&search='.$search.'&week='.$week.'&op=blacklist&startart='.$startart.'">
			<img src="../images/icon/off.gif" alt="'._MD_MYREFERER_DISPLAYED.'" align="absmiddle" /></a>';
...
myReferer_statmenu(8, '');
OpenTable();

// Display informations
echo"<table width='100%'><tr><td>";
echo "<b>".$xoopsConfig['sitename']."</b><br /><a href='stats_modules_referer.php?ord=$ord&search=$search&week=&op=$op&startart=$startart'>"._MD_MYREFERER_ALL."</a> | <a href='stats_modules_referer.php?ord=$ord&search=$search&week=1$&op=$op&startart=$startart'>$this_name : $this_date </a> | $black";
