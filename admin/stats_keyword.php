...
if ('del' === $op and $id) {
    ...
    xoops_confirm(['op' => $op, 'id' => $id, 'confirm' => 1, 'ord' => $ord, 'search' => $search, 'week' => $week, 'start' => $start], 'stats_keyword.php', _MD_MYREFERER_DELETE_KEYWORD . ' <br>' . '<br>' . $name . '<br>', _MD_MYREFERER_DELETE);
