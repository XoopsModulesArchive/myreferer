...
if ( $op == 'del' AND $id ) {
	if ($confirm) {
		...
		xoops_confirm(array('op' => $op, 'id' => $id, 'confirm' => 1, 'ord' => $ord, 'search' => $search, 'week' => $week, 'start' => $start), 'stats_query.php', _MD_MYREFERER_DELETE_QUERY . " <br />" . "<br />" . $name . "<br />", _MD_MYREFERER_DELETE);
