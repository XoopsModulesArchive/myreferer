...
if (isset($_POST['previewblock'])) {
    ...
    $bweighte = Request::getInt('bweight', 0, 'POST');

    $bvisible = Request::getInt('bvisible', 0, 'POST');

    $bmodule = Request::getString('bmodule', '', 'POST');
    ...
    if ('clone_ok' === $op) {
        $block['form_title'] = constant('CO_' . $moduleDirNameUpper . '_' . 'BLOCKS_CLONEBLOCK');
        ...
        $block['form_title'] = constant('CO_' . $moduleDirNameUpper . '_' . 'BLOCKS_EDITBLOCK');
...
if ('edit' === $op) {
    ...
    echo '<a href="myblocksadmin.php">' . _AM_BADMIN . '</a>&nbsp;<span style="font-weight:bold;">&raquo;&raquo;</span>&nbsp;' . constant('CO_' . $moduleDirNameUpper . '_' . 'BLOCKS_EDITBLOCK') . '<br><br>';
...
if ('clone' === $op) {
    ...
    echo '<a href="myblocksadmin.php">' . _AM_BADMIN . '</a>&nbsp;<span style="font-weight:bold;">&raquo;&raquo;</span>&nbsp;' . constant('CO_' . $moduleDirNameUpper . '_' . 'BLOCKS_CLONEBLOCK') . '<br><br>';
